      ...
      <svg className="brand-logo__mark" viewBox="0 0 128 128" aria-hidden="true" focusable="false">
        <defs>
          ...
          <linearGradient id={bookId} x1="28" y1="64" x2="101" y2="98" gradientUnits="userSpaceOnUse">
            ...
            <stop offset="1" stopColor="#fff6c9" />
          </linearGradient>
          <filter id={shadowId} x="-20%" y="-20%" width="140%" height="150%">
            <feDropShadow dx="0" dy="9" stdDeviation="7" floodColor="#31415c" floodOpacity=".18" />
          </filter>
        </defs>

        <rect width="128" height="128" rx="32" fill={`url(#${skyId})`} />
        <path d="M21 40c20-18 66-18 86 0" fill="none" stroke="#fff6c9" strokeWidth="11" strokeLinecap="round" opacity=".92" />
        ...
        <g filter={`url(#${shadowId})`}>
          ...
          <path d="M64 71v32" stroke="#8edbd1" strokeWidth="3" strokeLinecap="round" />
          <path d="M35 78c7-3 14-2 21 2M35 88c7-3 14-2 21 2M72 80c7-4 14-4 21-1M72 90c7-4 14-4 21-1" stroke="#b9adff" strokeWidth="3" strokeLinecap="round" opacity=".72" />
        </g>

        <circle cx="34" cy="31" r="10" fill="#fff6c9" />
        <circle cx="98" cy="34" r="8" fill="#ffffff" opacity=".88" />
        <path d="m92 19 3 7 8 1-6 5 2 8-7-4-7 4 2-8-6-5 8-1 3-7Z" fill="#ffe58f" stroke="#ffffff" strokeWidth="2" />

        <text x="64" y="63" textAnchor="middle" fontFamily="Rubik, Arial, sans-serif" fontSize="43" fontWeight="900" fill="#31415c">א</text>
        <text x="63" y="116" textAnchor="middle" fontFamily="Rubik, Arial, sans-serif" fontSize="18" fontWeight="900" fill="#31415c">123</text>
      </svg>
